...
// The public store listings for the ReadControl browser extension, now that it's
...
enum ExtensionStore {
    static let chrome = URL(
        string: "https://chromewebstore.google.com/detail/readcontrol/cegehgdbbjjeondepcaejickdmkacbck"
    )!
    static let firefox = URL(
        string: "https://addons.mozilla.org/en-US/firefox/addon/readcontrol"
    )!
}
