...
/// on-screen wording.
///
/// This file is compiled into **both** the `Óia` app target and the
/// `OiaUITests` target (it lives under `Sources/Oia/`, and the test
...
enum A11y {
    ...
    /// ── Browser extension ─────────────────────────────────────────────────
    /// Store-listing links in Settings › Extensions.
    enum Extensions {
