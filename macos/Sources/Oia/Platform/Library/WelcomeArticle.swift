...
enum WelcomeArticle {
    ...
    /// card self-contained until Óia has an official public website.
    ...
    private static let highlightedText = "Óia keeps everything you save right where you can find it."
    ...
    private static func articleContent(body: String) -> String {
        ...
        content += "rating: 0\n"
        content += "tags:\n- welcome\n"
        content += "excerpt: A guide to getting started with Óia, and a taste of what it can do.\n"
