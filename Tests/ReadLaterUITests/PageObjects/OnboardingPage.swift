...
struct OnboardingPage {
    ...
    var chooseLibraryButton: XCUIElement { app.byId(A11y.Onboarding.chooseLibrary) }
    var title: XCUIElement { app.byId(A11y.Onboarding.title) }

    var isVisible: Bool { chooseLibraryButton.exists }
